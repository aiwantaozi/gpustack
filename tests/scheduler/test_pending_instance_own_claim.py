...
Measured 2026-09-11 on `pdc-ascx-glm47-pd-1p2-7d2b`: the 7th decode replica sat
PENDING against two *empty* cards (3.3 GiB of stranded HBM, no process), each
reporting allocatable/total = 0.10 with its own claim as the only occupant.
Deleting the row dropped the claim and it scheduled immediately.
"""

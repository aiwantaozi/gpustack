...
def test_flag_reaches_the_config(tmp_path):
    """The whole point of the flag: the dashboards and the PD bandwidth
    self-check query `config.prometheus_url`, so an option the collector does
    not forward is a no-op that looks like it works."""

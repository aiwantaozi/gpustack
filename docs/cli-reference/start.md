...
| `--database-url` value              | `postgresql://user:password@host:port/db_name` | URL of the database. Supports PostgreSQL 13.0+, and MySQL 8.0+. Example: mysql://user:password@host:port/db_name                                                                        |

...
# was free and a member died of `torch.OutOfMemoryError ... 147.50 MiB is
# free`. The ledger read 30.9 GiB allocated where the cards held 42.8 -- 0.9
# of a card. A custom backend was booked at what its weights need, and vLLM
# behind it took the fraction it always takes.

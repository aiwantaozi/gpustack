"""A PD recipe's declared engine range, which used to bind nothing.

`backend_versions` in `pd-modes.yaml` was documented as "informational" and
behaved like it: an e2e round created PD models pinned to SGLang 0.5.5, vLLM
0.19.0, a nonexistent 9.9.9 and the string `not-a-version`, and all four were
